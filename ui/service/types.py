...
# Import shared types from our shared_types module
from shared_types import (
    Message, Task, TaskStatus, Artifact, JSONRPCMessage, JSONRPCRequest, 
    JSONRPCError, JSONRPCResponse, AgentCard, Part, Conversation, Event
)
